...
public class CoffeeMaker extends JFrame implements PropertyChangeListener, ActionListener {
    ...
    protected LocalDevice createDevice() throws org.fourthline.cling.model.ValidationException {
        ...
        DeviceDetails details = new DeviceDetails(friendlyName,
                ...
                new ModelDetails("VirtualCoffeeMaker", "A coffeemaker with 2 state run and not running", "v1"));
    ...
    // Resize image and change status  
    // Khi mà change status thì thằng controlpoint đăng ký lắng nghe thằng này sẽ biết được 
    // thằng này đã thay đổi status bằng hàm SubcriptionCallback
    // Do thằng subcriptioncall back đã đăng ký lắng service Switch Status
    @Override
